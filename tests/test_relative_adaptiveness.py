...
def test_arg_equivalence():
    ...
    assert relative_adaptiveness(sequences=["AAC"]) == relative_adaptiveness(RSCUs=RSCU(["AAC"]))

def test_weights():
    assert relative_adaptiveness(sequences=["AAC"]) == {'AAA': 1.0,
                                                        'AAC': 1.0,
                                                        'AAG': 1.0,
...
def test_alternate_genetic_code():
    assert relative_adaptiveness(sequences=["AAC"], genetic_code=10) == {'AAA': 1.0,
                                                                         'AAC': 1.0,
                                                                         'AAG': 1.0,
                                                                         'AAT': (0.5 / (0.5 * (1 + 0.5))) / (1 / (0.5 * (1 + 0.5))),
                                                                         'ACA': 1.0,
